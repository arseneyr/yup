...
var proto = (SchemaType.prototype = {
  ...
  _validate: function _validate(_value, options) {
    ...
    if (this._sequence) {
      return this._sequence.reduce(function(promise, schema) {
        return promise.then(function(result) {
          return schema._validate(_value, options).then([].concat.bind(result));
        });
      }, sync
        ? _synchronousPromise.SynchronousPromise.resolve([])
        : Promise.resolve([]));
    }
